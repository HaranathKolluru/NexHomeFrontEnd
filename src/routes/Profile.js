...
//     Axios.delete(`https://nexhome-backend-project.onrender.com/nexHome/delete/${currentUser._id}`)
...
function Profile() {
  ...
  function handleClick() {
    Axios.delete(
      `https://nexhome-backend-project.onrender.com/nexHome/delete/${currentUser._id}`
    )

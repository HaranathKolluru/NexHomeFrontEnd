...
function Sell() {
  ...
  const handleSubmit = (e) => {
    ...
    Axios.post(
      "https://nexhome-backend-project.onrender.com/sell/create-sell",
      data
    )
      .then(async (res) => {
        if (res.status === 200) {
      ...
      .then((retData) => {
        Axios.patch(
          `https://nexhome-backend-project.onrender.com/nexHome/updateSellData/${currentUser._id}`,
          retData
        ).then(async (res) => {
          if (res.status === 200) {
          ...
          <div className="about-property">
            ...
            <div className="city-location">
              ...
              <div className="name" style={{ fontWeight: "normal" }}>
                <label>Enter Your Propert name:</label>
                <input
                  placeholder="Enter Your Propert name"
                  type="text"
                  onChange={(e) => {
